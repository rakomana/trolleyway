                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="{{url('admin')}}"><i class="fe fe-home"></i> <span>Contact Us</span></a>
							</li>
							<li> 
								<a href="{{url('admin')}}"><i class="fe fe-home"></i> <span>About Us</span></a>
							</li>
						</ul>
					</div>
                </div>
						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-header">
									...
									<p class="card-text">Application Status, <b>{{$admin->status}}</b></p>
								</div>
								@endif
								@if(is_null($admin))
								...
								<div class="card-body">
									<div class="row">
										<div class="col-sm">
											...
											<form method="post" action="{{url('admin/register/shop')}}" enctype="multipart/form-data">
												@csrf
