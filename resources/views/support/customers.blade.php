										...
										<table class="table table-hover table-center">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right">
														<div class="actions">
															<a href="{{url('support/edit-customer/'.$user->id)}}" class="btn btn-sm bg-success-light mr-2">
																<i class="fe fe-pencil"></i> Edit
															</a>
															<a href="{{url('support/block/customer/'.$user->id)}}" class="btn btn-sm bg-danger-light">
