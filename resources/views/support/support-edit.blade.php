            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Support Info</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{url('support')}}">Dashboard</a></li>
									<li class="breadcrumb-item active">Support Info</li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="profile-header">
								<div class="row align-items-center">
									...
									<div class="col ml-md-n2 profile-user-info">
										<h4 class="user-name mb-0">{{$support->name}}</h4>
									</div>
								</div>
							</div>
											...
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														...
														<p class="col-sm-9">{{$support->name}}</p>
													</div>
													<div class="row">
														<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Email ID</p>
														<p class="col-sm-9">{{$support->email}}</p>
													</div>
												</div>
											</div>
