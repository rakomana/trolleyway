            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="{{url('seller')}}" class="logo">
						<img src="{{asset('uploads/shop/logos/'. $seller->shop_logo)}}" alt="Logo">
					</a>
					<a href="{{url('seller')}}" class="logo logo-small">
						<img src="{{asset('uploads/shop/logos/'. $seller->shop_logo)}}" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown">
						<a href="{{url('seller/profile')}}" class="dropdown-toggle nav-link">
