					...
					<div class="row">
						<div class="col-lg-3 col-md-4">
							<div class="compose-btn">
								<a href="{{url('seller/compose')}}" class="btn btn-primary btn-block">
								Compose
								</a>
							</div>
							<ul class="inbox-menu">
									...
									<div class="email-content">
										<div class="table-responsive">
											<table class="table table-inbox table-hover">
												...
												<tbody>
													<tr class="unread clickable-row" data-href="{{url('seller/mail-view')}}">
														<td>
													...
													<tr class="clickable-row" data-href="{{url('seller/mail-view')}}">
														<td>
															<input type="checkbox" class="checkmail">
														</td>
														<td><span class="mail-important"><i class="fa fa-star-o"></i></span></td>
