            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">{{$seller->shop_name}}</h3>
								<ul class="breadcrumb">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									{{-- <form @submit.prevent="submitFileAndData" id="implement"> --}}
										<form method="POST" action="{{url('/seller/shop/product')}}" id="implement" enctype="multipart/form-data">
										@csrf
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												...
												<input class="form-control @error('image') is-invalid @enderror" type="file" name="image[]" multiple required>
		...
		<script>
			const App = new Vue({
				...
				methods: {
					...
					this.loading = true;
					axios
						.post("/seller/shop/product", formData, {
						headers: {
