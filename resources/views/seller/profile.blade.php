							...
							<div class="profile-header">
								<div class="row align-items-center">
									...
									<div class="col ml-md-n2 profile-user-info">
										<h4 class="user-name mb-0">{{$seller->name}}</h4>
									</div>
											...
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														...
														<p class="col-sm-9">{{$seller->name}}</p>
													</div>
													<div class="row">
														<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Email ID</p>
														<p class="col-sm-9">{{$seller->email}}</p>
													</div>
												</div>
											</div>
										...
										<div class="card-body">
											...
											<div class="row">
												<div class="col-md-10 col-lg-6">
													...
													<form method="post" action="{{url('seller/account/change-password')}}">
														@csrf
